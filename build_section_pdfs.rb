...
if result
  ...
  puts ""
  puts "📁 Generated files are located in: ./section-pdfs/"
  puts "📊 Generation report: ./section-pdfs/generation_report.md"
  puts ""
  puts "🚀 To view all generated PDFs:"
  puts "   open ./section-pdfs/"
  puts ""
  puts "📖 To view the generation report:"
  puts "   open ./section-pdfs/generation_report.md"
else
  puts ""
